...
<div class="col-sm-12" style="padding-top:25px;">
    <div class="panel-group">
        <form class="form-horizontal" action="/dashboard/create_student/" method="post">
            <fieldset>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <legend>Leerling toevoegen</legend>
                        </h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="Roepnaam" name="Roepnaam" placeholder="" class="form-control input-md"
                                       required="" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="Tussenvoegsel" name="Tussenvoegsel" placeholder="van der"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="Achternaam" name="Achternaam" placeholder="" class="form-control input-md"
                                       required="" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="Geboortedatum" name="Geboortedatum" placeholder="20-12-2006"
