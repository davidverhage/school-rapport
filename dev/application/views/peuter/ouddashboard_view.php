                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-fw"
                                               href="<?php echo site_url() . 'dashboard/edit/' . $students[$i]->StudentID . '/1/' . $students[$i]->lhg; ?>"
                                               title="verslag een">
                                                verslag 1
                                            </a>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-fw"
                                               href="<?php echo site_url() . 'dashboard/edit/' . $students[$i]->StudentID . '/2/' . $students[$i]->lhg; ?>"
                                               title="verslag twee">
                                                verslag 2
                                            </a>
                                            <?php $group_table = 'tbl_g' . $students[$i]->lhg;
                                        ...
                                        <td><?php
                                            ...
                                            if ($query->num_rows() > 0) {
                                                foreach ($query->result() as $row) {
                                                    $verslagid = $row->id;
                                                    echo '<center><a href="/preview/build/' . $students[$i]->StudentID . '/' . $students[$i]->lhg . '/' . $verslagid . '"><img src="' . base_url() . 'assets/img/eye-icon.png" style="height:30px;" alt="&#x2713;"/></a></center>';
                                                }
                                                ...
                                                if ($query1->num_rows() > 0) {
                                                    foreach ($query1->result() as $row1) {
                                                        $verslagid2 = $row1->id;
                                                        echo '<center><a href="/preview/build/' . $students[$i]->StudentID . '/' . $students[$i]->lhg . '/' . $verslagid2 . '"><img src="' . base_url() . 'assets/img/eye-icon.png" style="height:30px;" alt="&#x2713;"/></a></center>';
                                                    }
                                                }
                                            } else {
                                                echo '';
                                        ...
                                        <td><?php
                                            ...
                                            if ($query->num_rows() > 0) {
                                                foreach ($query->result() as $row) {
                                                    $verslagid = $row->id;
                                                    echo '<center><a href="/dashboard/store_pdf/' . $students[$i]->StudentID . '/' . $students[$i]->lhg . '/' . $verslagid . '/true/"><img src="' . base_url() . 'assets/img/Download-pdf-icon.png" style="height:30px;" alt="&#x2713;"/></a></center>';
                                                }
                                            } elseif ($query->num_rows() < 1) {
                                                $group_table = 'tbl_g' . $students[$i]->lhg;
