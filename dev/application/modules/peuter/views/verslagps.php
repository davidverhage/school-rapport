        ...
        <div class="row ">
            ...
            <div class="well persoon">
                ...
                <h2><span
                    ...
                    } ?><?= $student->Achternaam; ?></h2>
                <br/>
                <span style="color:#666;"><h2>Peutergroep</h2></span>
                ...
                <div class="form-group">
                    <label class="col-sm-5" for="datum_periode">datum_periode</label>
                ...
                <div class="ui-widget form-group">
                    <label class="col-sm-5" for="tags" style="font-family:'Roboto', Arial, sans; font-size:12px;">Leid(st)er(s) </label>
            ...
            <section id="kosmisch" class="kosmisch-section form-block">
                <div class="row ">
                    <div class="well kosmi">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgik">Benoemt zichzelf als
                            'ik'</label>
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgcl">Heeft contact met de
                            leidster</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgck">Heeft contact met
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgss">Kan samen
                            spelen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgzo">Kan voor zichzelf
                            opkomen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgra">Houdt rekening met
                            anderen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgi">Neemt
                            initiatieven</label>
                        <div class="btn-group" data-toggle="buttons"><label
                                    class="btn btn-default <?php echo ($student->pvgcl == 3) ? 'active' : '' ?>">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgws">Kan zich aanpassen aan
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgaa">Houdt zich aan
                            afspraken</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgtv">Kan teleurstellingen
                            verwerken</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgrz">Ruimt zelfstandig
                            op</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgkc">Kan zich
                            concentreren</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgzw">Heeft zorg voor
                            werk</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgd">Heeft
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgk">Doet mee met
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgjs">Kan jas en schoenen
                            aandoen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgma">Neemt makkelijk
                            afscheid</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgzh">Geeft uit zichzelf een
                            hand</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgiz">Is zindelijk</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvgbo">Kan basisemoties
                            onderscheiden</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="pvghp">Vraagt om hulp</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <div class="form-group">
                            <label class="col-sm-5" for="pvg">Toelichting</label><br/>
            ...
            <section id="taal" class="taal-section form-block">
                <div class="row ">
                    <div class="well taal">
                        <h1>Taal</h1>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="tldv">Vertelt in de
                            kring</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="tlna">Luistert naar
                            anderen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="tlsv">Spreekt
                            verstaanbaar</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="tlz">Maakt zinnen </label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="tllz">Kan kritisch
                            luisteren</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <div class="form-group">
                            <label class="col-sm-5" for="tl">Toelichting</label><br/>
            ...
            <section id="rekenen" class="rekenen-section form-block">
                <div class="row ">
                    <div class="well rekenen">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="rkrb">Kan akoestisch
                            tellen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="rkst">Kan synchroon tellen tot
                            10</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="rkhh">Kan hoeveelheden
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="rks">Kan sorteren naar
                            vorm/grootte</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="rkgb"><b>Getalbegrip</b><br/>Kan
                        ...
                        <hr/>
                        <div class="form-group">
                            <label class="col-sm-5" for="rk">Toelichting</label><br/>
            ...
            <section id="creatief" class="creatieve-ontwikkeling-section form-block">
                <div class="row ">
                    <div class="well crea">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="cra">Kiest voor een creatieve
                            activiteit</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="crf">Gaat vanuit zijn/haar
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="crt">Tekent</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="crk">Kent kleuren</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="crsf">Speelt in de
                            fantasiehoek</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <div class="form-group">
                            <label class="col-sm-5" for="cr">Toelichting</label><br/>
            ...
            <section id="fijne" class="fijne-motoriek-section form-block">
                <div class="row ">
                    <div class="well schrijven">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmsk">Kan smalle stroken
                            knippen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmbk">Kan brede stroken
                            knippen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmvk">Kan een vierkant
                            knippen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmck">Kan een cirkel
                            knippen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmsl">Kan een spiraal
                            knippen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="fmgp">Heeft een goede
                            pengreep</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5"
                        ...
                        <hr/>
                        <div class="form-group">
                            <label class="col-sm-5" for="fm">Toelichting</label><br/>
            ...
            <section id="grove" class="grove-motoriek-section form-block">
                <div class="row ">
                    <div class="well schrijven">
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="gmf">Kan fietsen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <label style="padding-top:10px !important;" class="col-sm-5" for="gmas">Durft ergens af te
                            springen</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="gmsb">Speelt en beweegt met
                            plezier</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="gmbm">Beweegt graag op
                            muziek</label>
                        <div class="btn-group" data-toggle="buttons"><label
                        ...
                        <hr/>
                        <label style="padding-top:10px !important;" class="col-sm-5" for="gmbs">Beweegt zich
                            soepel</label>
                        <div class="btn-group" data-toggle="buttons"><label
            ...
            <section id="opmerkingen" class="overige-opmerkingen-section  form-block">
                <div class="row ">
                    <div class="well oo">
                        ...
                        <div class="form-group"><label class="col-sm-5" for="oo_verslag"> Verslag </label><br/>
            ...
            <section id="notes" class="notities-section  form-block">
                <div class="row">
                    <div class="well">
                        ...
                        <div class="form-group"><label class="col-sm-5" for="notes"> Eigen notities </label><br/>
