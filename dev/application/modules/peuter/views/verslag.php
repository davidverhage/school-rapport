    ...
    <div class="row-fluid">
        <ul class="nav nav-pills nav-stacked">
            ...
            <?php if ($this->user->has_permission('special_g') || $this->user->has_permission('special_c')) {
                ...
                <li>
                    <a class="page-scroll" href="#" data-id="imageControl">Foto toevoegen</a>
                </li>
                <li>
...
<div class="col-xs-12 col-sm-9 scrollit" style="padding-top:55px;">
    ...
    <form action="/dashboard/store/<?= $student->id; ?>/<?= $student->lhg; ?>/<?= $student->schooljaar; ?>/<?= $student->tbl_student_id; ?>"
        ...
        <div class="row ">
            ...
            <div class="well persoon">
                ...
                <div class="form-group">
                    <label class="col-sm-3" for="datum_periode">Datum / periode</label>
                ...
                <div class="ui-widget form-group">
                    ...
                    <input id="tags" name="leidsters" value="<?= $student->leidsters; ?>" class="form-control"
                           size="50"><span
                            style="font-size:11px;font-family:'Roboto', Arial, sans;padding-left:17px;"><em>meer toevoegen gebruik de komma ( , )</em></span>
                </div>
            </div>
                            ...
                            <div class="btn-group" data-target="group_gym_in" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->gym_in == 10) ? 'active' : '' ?>"><input
                                            name="gym_in" type="radio"
                                            value="10" <?php echo ($student->gym_in == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="gym_in" type="button" class="btn btn-default clearRadio">
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->gym_sv == 10) ? 'active' : '' ?>"><input
                                            name="gym_sv" type="radio"
                                            value="10" <?php echo ($student->gym_sv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="gym_sv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->gym_mv == 10) ? 'active' : '' ?>"><input
                                            name="gym_mv" type="radio"
                                            value="10" <?php echo ($student->gym_mv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="gym_mv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="well taal">
                        ...
                        <?php if ($value > 2) { ?>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_tl" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_bl == 10) ? 'active' : '' ?>"><input
                                            name="taal_bl" type="radio"
                                            value="10" <?php echo ($student->taal_bl == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_bl" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_uv == 10) ? 'active' : '' ?>"><input
                                            name="taal_uv" type="radio"
                                            value="10" <?php echo ($student->taal_uv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_uv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_bb == 10) ? 'active' : '' ?>"><input
                                            name="taal_bb" type="radio"
                                            value="10" <?php echo ($student->taal_bb == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_bb" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_st == 10) ? 'active' : '' ?>"><input
                                            name="taal_st" type="radio"
                                            value="10" <?php echo ($student->taal_st == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_st" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_sp == 10) ? 'active' : '' ?>"><input
                                            name="taal_sp" type="radio"
                                            value="10" <?php echo ($student->taal_sp == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_sp" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_dv == 10) ? 'active' : '' ?>"><input
                                            name="taal_dv" type="radio"
                                            value="10" <?php echo ($student->taal_dv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_dv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_zb == 10) ? 'active' : '' ?>"><input
                                            name="taal_zb" type="radio"
                                            value="10" <?php echo ($student->taal_zb == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_zb" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_ws == 10) ? 'active' : '' ?>"><input
                                            name="taal_ws" type="radio"
                                            value="10" <?php echo ($student->taal_ws == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_ws" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_ag == 10) ? 'active' : '' ?>"><input
                                            name="taal_ag" type="radio"
                                            value="10" <?php echo ($student->taal_ag == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_ag" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_vv == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_vv" type="radio"
                                            value="10" <?php echo ($student->taal_lv_vv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_vv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_kh == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_kh" type="radio"
                                            value="10" <?php echo ($student->taal_lv_kh == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_kh" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_lv == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_lv" type="radio"
                                            value="10" <?php echo ($student->taal_lv_lv == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_lv" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_rij == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_rij" type="radio"
                                            value="10" <?php echo ($student->taal_lv_rij == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_rij" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_lwz == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_lwz" type="radio"
                                            value="10" <?php echo ($student->taal_lv_lwz == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_lwz" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_kw == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_kw" type="radio"
                                            value="10" <?php echo ($student->taal_lv_kw == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_kw" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_ks == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_ks" type="radio"
                                            value="10" <?php echo ($student->taal_lv_ks == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_ks" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_ka == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_ka" type="radio"
                                            value="10" <?php echo ($student->taal_lv_ka == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_ka" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_lv_l10 == 10) ? 'active' : '' ?>"><input
                                            name="taal_lv_l10" type="radio"
                                            value="10" <?php echo ($student->taal_lv_l10 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_lv_l10" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_mm == 10) ? 'active' : '' ?>"><input
                                            name="taal_mm" type="radio"
                                            value="10" <?php echo ($student->taal_mm == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_mm" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label
                                    class="btn btn-default <?php echo ($student->taal_lv_en == 10) ? 'active' : '' ?>"><input
                                        name="taal_lv_en" type="radio"
                                        value="10" <?php echo ($student->taal_lv_en == 10) ? 'checked="checked"' : '' ?>>
                                G</label>
                            <!-- reset selection -->
                            <div class="pull-right">
                                <button name="taal_lv_en" type="button" class="btn btn-default clearRadio">
                                    <i class="fa fa-refresh" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->taal_en8 == 10) ? 'active' : '' ?>"><input
                                            name="taal_en8" type="radio"
                                            value="10" <?php echo ($student->taal_en8 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="taal_en8" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_rb == 10) ? 'active' : '' ?>"><input
                                            name="reken_rb" type="radio"
                                            value="10" <?php echo ($student->reken_rb == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_rb" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gb6 == 10) ? 'active' : '' ?>"><input
                                            name="reken_gb6" type="radio"
                                            value="10" <?php echo ($student->reken_gb6 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gb6" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gb12 == 10) ? 'active' : '' ?>"><input
                                            name="reken_gb12" type="radio"
                                            value="10" <?php echo ($student->reken_gb12 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gb12" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gb10 == 10) ? 'active' : '' ?>"><input
                                            name="reken_gb10" type="radio"
                                            value="10" <?php echo ($student->reken_gb10 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gb10" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gb20 == 10) ? 'active' : '' ?>"><input
                                            name="reken_gb20" type="radio"
                                            value="10" <?php echo ($student->reken_gb20 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gb20" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_r10 == 10) ? 'active' : '' ?>"><input
                                            name="reken_r10" type="radio"
                                            value="10" <?php echo ($student->reken_r10 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_r10" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_r20 == 10) ? 'active' : '' ?>"><input
                                            name="reken_r20" type="radio"
                                            value="10" <?php echo ($student->reken_r20 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_r20" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons"><label
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_r50 == 10) ? 'active' : '' ?>"><input
                                            name="reken_r50" type="radio"
                                            value="10" <?php echo ($student->reken_r50 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_r50" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_r100 == 10) ? 'active' : '' ?>"><input
                                            name="reken_r100" type="radio"
                                            value="10" <?php echo ($student->reken_r100 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_r100" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_r1000 == 10) ? 'active' : '' ?>"><input
                                            name="reken_r1000" type="radio"
                                            value="10" <?php echo ($student->reken_r1000 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_r1000" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_k5 == 10) ? 'active' : '' ?>"><input
                                            name="reken_k5" type="radio"
                                            value="10" <?php echo ($student->reken_k5 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_k5" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_k10 == 10) ? 'active' : '' ?>"><input
                                            name="reken_k10" type="radio"
                                            value="10" <?php echo ($student->reken_k10 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_k10" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_wk == 10) ? 'active' : '' ?>"><input
                                            name="reken_wk" type="radio"
                                            value="10" <?php echo ($student->reken_wk == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_wk" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_bh == 10) ? 'active' : '' ?>"><input
                                            name="reken_bh" type="radio"
                                            value="10" <?php echo ($student->reken_bh == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_bh" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_a10 == 10) ? 'active' : '' ?>"><input
                                            name="reken_a10" type="radio"
                                            value="10" <?php echo ($student->reken_a10 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_a10" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_a20 == 10) ? 'active' : '' ?>"><input
                                            name="reken_a20" type="radio"
                                            value="10" <?php echo ($student->reken_a20 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_a20" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_ee == 10) ? 'active' : '' ?>"><input
                                            name="reken_ee" type="radio"
                                            value="10" <?php echo ($student->reken_ee == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_ee" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_pos == 10) ? 'active' : '' ?>"><input
                                            name="reken_pos" type="radio"
                                            value="10" <?php echo ($student->reken_pos == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_pos" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_h4 == 10) ? 'active' : '' ?>"><input
                                            name="reken_h4" type="radio"
                                            value="10" <?php echo ($student->reken_h4 == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_h4" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label
                                    class="btn btn-default <?php echo ($student->reken_mm == 10) ? 'active' : '' ?>"><input
                                        name="reken_mm" type="radio"
                                        value="10" <?php echo ($student->reken_mm == 10) ? 'checked="checked"' : '' ?>>
                                G</label>
                            <!-- reset selection -->
                            <div class="pull-right">
                                <button name="reken_mm" type="button" class="btn btn-default clearRadio">
                                    <i class="fa fa-refresh" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_td == 10) ? 'active' : '' ?>"><input
                                            name="reken_td" type="radio"
                                            value="10" <?php echo ($student->reken_td == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_td" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gg == 10) ? 'active' : '' ?>"><input
                                            name="reken_gg" type="radio"
                                            value="10" <?php echo ($student->reken_gg == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gg" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_gld == 10) ? 'active' : '' ?>"><input
                                            name="reken_gld" type="radio"
                                            value="10" <?php echo ($student->reken_gld == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_gld" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->reken_mem == 10) ? 'active' : '' ?>"><input
                                            name="reken_mem" type="radio"
                                            value="10" <?php echo ($student->reken_mem == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="reken_mem" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->motor_kg == 10) ? 'active' : '' ?>"><input
                                            name="motor_kg" type="radio"
                                            value="10" <?php echo ($student->motor_kg == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="motor_kg" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->motor_ohc == 10) ? 'active' : '' ?>"><input
                                            name="motor_ohc" type="radio"
                                            value="10" <?php echo ($student->motor_ohc == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="motor_ohc" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_fm == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_fm" type="radio"
                                            value="10" <?php echo ($student->schrijf_fm == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_fm" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_vl == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_vl" type="radio"
                                            value="10" <?php echo ($student->schrijf_vl == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_vl" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_sh == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_sh" type="radio"
                                            value="10" <?php echo ($student->schrijf_sh == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_sh" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_pg == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_pg" type="radio"
                                            value="10" <?php echo ($student->schrijf_pg == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_pg" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_vz == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_vz" type="radio"
                                            value="10" <?php echo ($student->schrijf_vz == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_vz" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_lh == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_lh" type="radio"
                                            value="10" <?php echo ($student->schrijf_lh == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_lh" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->schrijf_bi == 10) ? 'active' : '' ?>"><input
                                            name="schrijf_bi" type="radio"
                                            value="10" <?php echo ($student->schrijf_bi == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="schrijf_bi" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label
                                    class="btn btn-default <?php echo ($student->kosmi_in == 10) ? 'active' : '' ?>"><input
                                        name="kosmi_in" type="radio"
                                        value="10" <?php echo ($student->kosmi_in == 10) ? 'checked="checked"' : '' ?>>
                                G</label>
                            <!-- reset selection -->
                            <div class="pull-right">
                                <button name="kosmi_in" type="button" class="btn btn-default clearRadio">
                                    <i class="fa fa-refresh" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_kk == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_kk" type="radio"
                                            value="10" <?php echo ($student->kosmi_kk == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_kk" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_pr == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_pr" type="radio"
                                            value="10" <?php echo ($student->kosmi_pr == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_pr" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_ws == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_ws" type="radio"
                                            value="10" <?php echo ($student->kosmi_ws == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_ws" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_tn == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_tn" type="radio"
                                            value="10" <?php echo ($student->kosmi_tn == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_tn" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_sb == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_sb" type="radio"
                                            value="10" <?php echo ($student->kosmi_sb == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_sb" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_mm == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_mm" type="radio"
                                            value="10" <?php echo ($student->kosmi_mm == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_mm" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="btn-group" data-toggle="buttons">
                                ...
                                <label
                                        class="btn btn-default <?php echo ($student->kosmi_vk == 10) ? 'active' : '' ?>"><input
                                            name="kosmi_vk" type="radio"
                                            value="10" <?php echo ($student->kosmi_vk == 10) ? 'checked="checked"' : '' ?>>
                                    G</label>
                                <!-- reset selection -->
                                <div class="pull-right">
                                    <button name="kosmi_vk" type="button" class="btn btn-default clearRadio">
                                        <i class="fa fa-refresh" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
            ...
            <section id="creatief" class="creatieve-ontwikkeling-section form-block">
                <div class="row ">
                    ...
                    <div class="well crea" id="imageControl">
                        <?php if ($student->uploaded_art == null || $student->uploaded_art == '') { ?>
                            <h1>Foto/Afbeelding toevoegen</h1>
                            <div id="photouploads_div" class="form-group">
                                <div id="photo_upload" class="img-responsive">
                                    <img id="image_upload" src="noimage.gif" alt="your image" style="width:200px;"
                                         class="img-responsive">
                                </div>
                                <label for="photo_file">Upload afbeelding </label>
                                <div id="img_loader" style="display:none; float:left;"><img src="ajax-loader.gif"></div>
                                <input type="file" name="photo_file[]" id="photo_file"
                                       onchange="readURL(this);"><br><br>
                            </div>
                            <input type="hidden" name="uploaded_art" placeholder="bestandsnaam" id="uploadtoDb"
                                   readonly>
                        <?php } else { ?>
                            <div class="imageContainer" id="imageConsole" style="position: relative;">
                                <button type="button" id="removeImage"
                                        data-userId="<?php echo $this->uri->segment(3); ?>"
                                        data-userGroup="<?php echo $this->uri->segment(5); ?>"
                                        class="btn btn-danger btn-md"
                                        style="position: absolute; left:auto; right: 16px; top: 16px; bottom:auto; z-index:999;">
                                    &times;
                                </button>
                                <img id="image_upload" src="<?php echo $student->uploaded_art; ?>" alt="your image"
                                     style="width:200px;" class="img-responsive">
                            </div>
                        <?php } ?>
                    </div>
                    <hr/>
