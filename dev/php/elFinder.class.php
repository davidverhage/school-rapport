...
class elFinder
{
    ...
    const ERROR_ACCESS_DENIED = 'errAccess';     // 'File not found.'
    const ERROR_NOT_REPLACE = 'errNotReplace'; // 'Target folder "$1" not found.'
    const ERROR_SAVE = 'errSave';
    const ERROR_EXTRACT = 'errExtract';
    const ERROR_ARCHIVE = 'errArchive';
    const ERROR_NOT_ARCHIVE = 'errNoArchive';        // '"$1" is locked and can not be renamed, moved or removed.'
    const ERROR_ARCHIVE_TYPE = 'errArcType';        // 'File named "$1" already exists.'
    const ERROR_ARC_SYMLINKS = 'errArcSymlinks';       // 'Invalid file name.'
    ...
    const ERROR_NETMOUNT_FAILED = 'errNetMountFailed';          // 'Unable to replace "$1".'
    const ERROR_SESSION_EXPIRES = 'errSessionExpires';               // 'Unable to remove "$1".'
    const ERROR_CREATING_TEMP_DIR = 'errCreatingTempDir';            // 'Unable remove source file(s)'
    const ERROR_FTP_DOWNLOAD_FILE = 'errFtpDownloadFile';        // 'Unable to create a link to outside the volume root.'
    const ERROR_FTP_UPLOAD_FILE = 'errFtpUploadFile';           // 'Upload error.'
    const ERROR_FTP_MKDIR = 'errFtpMkdir';       // 'Unable to upload "$1".'
    const ERROR_ARCHIVE_EXEC = 'errArchiveExec';    // 'No files found for upload.'
    const ERROR_EXTRACT_EXEC = 'errExtractExec';  // 'Data exceeds the maximum allowed size.'
    const ERROR_SEARCH_TIMEOUT = 'errSearchTimeout';   // 'File exceeds maximum allowed size.'
    const ERROR_REAUTH_REQUIRE = 'errReauthRequire';       // 'File type not allowed.'
    /**
     * Network mount drivers
     *
     * @var array
     */
    public static $netDrivers = array();   // '"$1" transfer error.'
    /**
     * elFinder global locale
     *
     * @var string
     */
    public static $locale = '';       // 'Unable to make temporary file for upload.'
    /**
     ...
     * @var string
     */
    public static $sessionCacheKey = '';       // Object "$1" already exists at this location and can not be replaced with object of another type.
    /**
     ...
     * @var string
     **/
    protected $uploadDebug = '';    // 'Timed out while searching "$1". Search result is partial.'
    /**
     ...
     * @var string URL
     */
    protected $callbackWindowURL = '';  // 'Re-authorization is required.'
